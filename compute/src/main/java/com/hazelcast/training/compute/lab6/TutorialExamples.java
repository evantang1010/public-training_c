package com.hazelcast.training.compute.lab6;/*
...
import com.hazelcast.training.compute.lab6.csv.ReaderHelper;
import com.hazelcast.training.compute.lab6.tutorials.*;
...
public class TutorialExamples {
    ...
    private static HazelcastInstance buildCluster(int memberCount) {
        ...
        //add license
        config.setLicenseKey( "ENTERPRISE_HD#10Nodes#ENjb6waySV1mkAHr07fUTKluO5JIF7600100091100511101109701111191" );
